...
target: **one new ADR** (residency + control plane + arbitration; number assigned by Nico at
graduation — next free is 0013). **ADR-0012 stays fully reserved** — the control plane
