...
return resumeSession(_that);case GridSessionVoid() when voidSession != null:
return voidSession(_that);case GridSetAdmissionCeiling() when setAdmissionCeiling != null:
return setAdmissionCeiling(_that);case GridBeadBoard() when board != null:
...
return resumeSession(_that);case GridSessionVoid():
return voidSession(_that);case GridSetAdmissionCeiling():
return setAdmissionCeiling(_that);case GridBeadBoard():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( GridRework value)?  rework,TResult? Function( GridGateLs value)?  listGates,TResult? Function( GridGateResolve value)?  resolveGate,TResult? Function( GridSessionLs value)?  listHeldSessions,TResult? Function( GridSessionCollect value)?  collectHeldSessions,TResult? Function( GridSetBeadText value)?  setBeadText,TResult? Function( GridMountAttemptRearm value)?  rearmMountAttempt,TResult? Function( GridPauseSession value)?  pauseSession,TResult? Function( GridResumeSession value)?  resumeSession,TResult? Function( GridSessionVoid value)?  voidSession,TResult? Function( GridSetAdmissionCeiling value)?  setAdmissionCeiling,TResult? Function( GridBeadBoard value)?  board,TResult? Function( GridBeadRound value)?  beadRound,TResult? Function( GridAttachSubstation value)?  attachSubstation,TResult? Function( GridDetachSubstation value)?  detachSubstation,}){
final _that = this;
switch (_that) {
case GridRework() when rework != null:
return rework(_that);case GridGateLs() when listGates != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String beadId,  String? note,  bool beyondCap,  String? actor)?  rework,TResult Function()?  listGates,TResult Function( String gateId,  Map<String, String> grades,  String? rationale)?  resolveGate,TResult Function()?  listHeldSessions,TResult Function( List<String> sessionIds,  bool act,  bool bulk,  bool overrideUnsafe)?  collectHeldSessions,TResult Function( String beadId,  OperatorBeadTextField field,  String content,  bool append,  bool allowNotesReplacement)?  setBeadText,TResult Function( String beadId,  String actor,  String reason)?  rearmMountAttempt,TResult Function( String beadId)?  pauseSession,TResult Function( String beadId)?  resumeSession,TResult Function( String sessionId,  String reason)?  voidSession,TResult Function( int maxAgents)?  setAdmissionCeiling,TResult Function( Set<String> stores,  Set<String> statuses,  bool blockedOnly,  bool? approved)?  board,TResult Function( String beadId)?  beadRound,TResult Function( String name,  String root,  String? prefix)?  attachSubstation,TResult Function( String name,  bool force)?  detachSubstation,required TResult orElse(),}) {final _that = this;
switch (_that) {
case GridRework() when rework != null:
...
return resumeSession(_that.beadId);case GridSessionVoid() when voidSession != null:
return voidSession(_that.sessionId,_that.reason);case GridSetAdmissionCeiling() when setAdmissionCeiling != null:
return setAdmissionCeiling(_that.maxAgents);case GridBeadBoard() when board != null:
...
return resumeSession(_that.beadId);case GridSessionVoid():
return voidSession(_that.sessionId,_that.reason);case GridSetAdmissionCeiling():
return setAdmissionCeiling(_that.maxAgents);case GridBeadBoard():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String beadId,  String? note,  bool beyondCap,  String? actor)?  rework,TResult? Function()?  listGates,TResult? Function( String gateId,  Map<String, String> grades,  String? rationale)?  resolveGate,TResult? Function()?  listHeldSessions,TResult? Function( List<String> sessionIds,  bool act,  bool bulk,  bool overrideUnsafe)?  collectHeldSessions,TResult? Function( String beadId,  OperatorBeadTextField field,  String content,  bool append,  bool allowNotesReplacement)?  setBeadText,TResult? Function( String beadId,  String actor,  String reason)?  rearmMountAttempt,TResult? Function( String beadId)?  pauseSession,TResult? Function( String beadId)?  resumeSession,TResult? Function( String sessionId,  String reason)?  voidSession,TResult? Function( int maxAgents)?  setAdmissionCeiling,TResult? Function( Set<String> stores,  Set<String> statuses,  bool blockedOnly,  bool? approved)?  board,TResult? Function( String beadId)?  beadRound,TResult? Function( String name,  String root,  String? prefix)?  attachSubstation,TResult? Function( String name,  bool force)?  detachSubstation,}) {final _that = this;
switch (_that) {
case GridRework() when rework != null:
return rework(_that.beadId,_that.note,_that.beyondCap,_that.actor);case GridGateLs() when listGates != null:
return listGates();case GridGateResolve() when resolveGate != null:
...
class GridSessionLs implements GridCommandRequest {
  const GridSessionLs();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GridSessionLs);
}
...
@override
String toString() {
  return 'GridCommandRequest.listHeldSessions()';
}
...
class GridSessionCollect implements GridCommandRequest {
  const GridSessionCollect({required final  List<String> sessionIds, this.act = false, this.bulk = false, this.overrideUnsafe = false}): _sessionIds = sessionIds;
...
@JsonKey() final  bool act;
@JsonKey() final  bool bulk;
@JsonKey() final  bool overrideUnsafe;

/// Create a copy of GridCommandRequest
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GridSessionCollectCopyWith<GridSessionCollect> get copyWith => _$GridSessionCollectCopyWithImpl<GridSessionCollect>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GridSessionCollect&&const DeepCollectionEquality().equals(other._sessionIds, _sessionIds)&&(identical(other.act, act) || other.act == act)&&(identical(other.bulk, bulk) || other.bulk == bulk)&&(identical(other.overrideUnsafe, overrideUnsafe) || other.overrideUnsafe == overrideUnsafe));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_sessionIds),act,bulk,overrideUnsafe);

@override
String toString() {
  return 'GridCommandRequest.collectHeldSessions(sessionIds: $sessionIds, act: $act, bulk: $bulk, overrideUnsafe: $overrideUnsafe)';
}
...
/// @nodoc
abstract mixin class $GridSessionCollectCopyWith<$Res> implements $GridCommandRequestCopyWith<$Res> {
  factory $GridSessionCollectCopyWith(GridSessionCollect value, $Res Function(GridSessionCollect) _then) = _$GridSessionCollectCopyWithImpl;
@useResult
$Res call({
 List<String> sessionIds, bool act, bool bulk, bool overrideUnsafe
});
...
/// @nodoc
class _$GridSessionCollectCopyWithImpl<$Res>
    implements $GridSessionCollectCopyWith<$Res> {
  _$GridSessionCollectCopyWithImpl(this._self, this._then);

  final GridSessionCollect _self;
  final $Res Function(GridSessionCollect) _then;

/// Create a copy of GridCommandRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? sessionIds = null,Object? act = null,Object? bulk = null,Object? overrideUnsafe = null,}) {
  return _then(GridSessionCollect(
sessionIds: null == sessionIds ? _self._sessionIds : sessionIds // ignore: cast_nullable_to_non_nullable
as List<String>,act: null == act ? _self.act : act // ignore: cast_nullable_to_non_nullable
as bool,bulk: null == bulk ? _self.bulk : bulk // ignore: cast_nullable_to_non_nullable
as bool,overrideUnsafe: null == overrideUnsafe ? _self.overrideUnsafe : overrideUnsafe // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@JsonKey() final  bool allowNotesReplacement;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GridSetBeadText&&(identical(other.beadId, beadId) || other.beadId == beadId)&&(identical(other.field, field) || other.field == field)&&(identical(other.content, content) || other.content == content)&&(identical(other.append, append) || other.append == append)&&(identical(other.allowNotesReplacement, allowNotesReplacement) || other.allowNotesReplacement == allowNotesReplacement));
}


@override
int get hashCode => Object.hash(runtimeType,beadId,field,content,append,allowNotesReplacement);

@override
String toString() {
  return 'GridCommandRequest.setBeadText(beadId: $beadId, field: $field, content: $content, append: $append, allowNotesReplacement: $allowNotesReplacement)';
}
...
@useResult
$Res call({
 String beadId, OperatorBeadTextField field, String content, bool append, bool allowNotesReplacement
});
...
/// Create a copy of GridCommandRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? beadId = null,Object? field = null,Object? content = null,Object? append = null,Object? allowNotesReplacement = null,}) {
...
class GridPauseSession implements GridCommandRequest {
  const GridPauseSession({required this.beadId});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GridPauseSessionCopyWith<GridPauseSession> get copyWith => _$GridPauseSessionCopyWithImpl<GridPauseSession>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GridPauseSession&&(identical(other.beadId, beadId) || other.beadId == beadId));
}
...
@override
String toString() {
  return 'GridCommandRequest.pauseSession(beadId: $beadId)';
}
...
/// @nodoc
abstract mixin class $GridPauseSessionCopyWith<$Res> implements $GridCommandRequestCopyWith<$Res> {
  factory $GridPauseSessionCopyWith(GridPauseSession value, $Res Function(GridPauseSession) _then) = _$GridPauseSessionCopyWithImpl;
@useResult
$Res call({
 String beadId
});
...
/// @nodoc
class _$GridPauseSessionCopyWithImpl<$Res>
    implements $GridPauseSessionCopyWith<$Res> {
  _$GridPauseSessionCopyWithImpl(this._self, this._then);

  final GridPauseSession _self;
  final $Res Function(GridPauseSession) _then;

/// Create a copy of GridCommandRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? beadId = null,}) {
  return _then(GridPauseSession(
beadId: null == beadId ? _self.beadId : beadId // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class GridResumeSession implements GridCommandRequest {
  const GridResumeSession({required this.beadId});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GridResumeSessionCopyWith<GridResumeSession> get copyWith => _$GridResumeSessionCopyWithImpl<GridResumeSession>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GridResumeSession&&(identical(other.beadId, beadId) || other.beadId == beadId));
}
...
@override
String toString() {
  return 'GridCommandRequest.resumeSession(beadId: $beadId)';
}
...
/// @nodoc
abstract mixin class $GridResumeSessionCopyWith<$Res> implements $GridCommandRequestCopyWith<$Res> {
  factory $GridResumeSessionCopyWith(GridResumeSession value, $Res Function(GridResumeSession) _then) = _$GridResumeSessionCopyWithImpl;
@useResult
$Res call({
 String beadId
});
...
/// @nodoc
class _$GridResumeSessionCopyWithImpl<$Res>
    implements $GridResumeSessionCopyWith<$Res> {
  _$GridResumeSessionCopyWithImpl(this._self, this._then);

  final GridResumeSession _self;
  final $Res Function(GridResumeSession) _then;

/// Create a copy of GridCommandRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? beadId = null,}) {
  return _then(GridResumeSession(
beadId: null == beadId ? _self.beadId : beadId // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class GridSessionVoid implements GridCommandRequest {
  const GridSessionVoid({required this.sessionId, required this.reason});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GridSessionVoidCopyWith<GridSessionVoid> get copyWith => _$GridSessionVoidCopyWithImpl<GridSessionVoid>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GridSessionVoid&&(identical(other.sessionId, sessionId) || other.sessionId == sessionId)&&(identical(other.reason, reason) || other.reason == reason));
}
...
@override
String toString() {
  return 'GridCommandRequest.voidSession(sessionId: $sessionId, reason: $reason)';
}
...
/// @nodoc
abstract mixin class $GridSessionVoidCopyWith<$Res> implements $GridCommandRequestCopyWith<$Res> {
  factory $GridSessionVoidCopyWith(GridSessionVoid value, $Res Function(GridSessionVoid) _then) = _$GridSessionVoidCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$GridSessionVoidCopyWithImpl<$Res>
    implements $GridSessionVoidCopyWith<$Res> {
  _$GridSessionVoidCopyWithImpl(this._self, this._then);

  final GridSessionVoid _self;
  final $Res Function(GridSessionVoid) _then;

/// Create a copy of GridCommandRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? sessionId = null,Object? reason = null,}) {
  return _then(GridSessionVoid(
...
class GridSetAdmissionCeiling implements GridCommandRequest {
  const GridSetAdmissionCeiling({required this.maxAgents});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GridSetAdmissionCeilingCopyWith<GridSetAdmissionCeiling> get copyWith => _$GridSetAdmissionCeilingCopyWithImpl<GridSetAdmissionCeiling>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GridSetAdmissionCeiling&&(identical(other.maxAgents, maxAgents) || other.maxAgents == maxAgents));
}


@override
int get hashCode => Object.hash(runtimeType,maxAgents);

@override
String toString() {
  return 'GridCommandRequest.setAdmissionCeiling(maxAgents: $maxAgents)';
}
...
/// @nodoc
abstract mixin class $GridSetAdmissionCeilingCopyWith<$Res> implements $GridCommandRequestCopyWith<$Res> {
  factory $GridSetAdmissionCeilingCopyWith(GridSetAdmissionCeiling value, $Res Function(GridSetAdmissionCeiling) _then) = _$GridSetAdmissionCeilingCopyWithImpl;
@useResult
$Res call({
 int maxAgents
});
...
/// @nodoc
class _$GridSetAdmissionCeilingCopyWithImpl<$Res>
    implements $GridSetAdmissionCeilingCopyWith<$Res> {
  _$GridSetAdmissionCeilingCopyWithImpl(this._self, this._then);

  final GridSetAdmissionCeiling _self;
  final $Res Function(GridSetAdmissionCeiling) _then;

/// Create a copy of GridCommandRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? maxAgents = null,}) {
  return _then(GridSetAdmissionCeiling(
maxAgents: null == maxAgents ? _self.maxAgents : maxAgents // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
