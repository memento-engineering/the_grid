...
//
// `assembleStationWork` cannot be driven to a successful build offline (it
...
void main() {
  test(
    'assembleStationWork passes the unresolved sink into StationJoinBridge',
    () {
      ...
      expect(
        ...
        isTrue,
        reason:
            'assembleStationWork must hand StationJoinBridge the same LOUD sink the '
