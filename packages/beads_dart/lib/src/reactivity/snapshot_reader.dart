...
/// * the CLI fallback: registered type/status scopes + `bd ready`.
///
...
/// Ephemeral beads live in separate `wisps` tables; scoped readers retain
/// them by enumerating the registered vocabulary and statuses.
