  ...
  group('BdCliService reads (FakeBdRunner + pinned fixtures)', () {
    ...
    group(
      ...
      () {
        ...
        test(
          'exportAll() falls back to `list --all --json` when proxied-server '
          'mode refuses export, parsing the array shape',
          () async {
            final runner = FakeBdRunner()
              ..stubCommand(
                'export',
      ...
      skip: 'the export API is a throwing compatibility tombstone',
    );
