...
/// its formula subtree (ADR-0008 D4 / M4-P1 D-2).
///
...
/// `FormulaScope` + every `CapabilityHost` attach to the SAME session (the
...
/// session bead all of the formula's cursor writes target (A37 / invariant 4).
class SessionHandle {
